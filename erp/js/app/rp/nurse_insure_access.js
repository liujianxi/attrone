	...
	'                     <div class="col-sm-5">'+
	'                        <label class="radio-inline" style="padding-top:0px;"><div class="radio"><input type="radio" name="kinsnurseolk_actAbility" value="1" checked> 自理</div></label>'+
	'                        <label class="radio-inline" style="padding-top:0px;"><div class="radio"><input type="radio" name="kinsnurseolk_actAbility" value="2"> 半失能</div></label>'+
	'                        <label class="radio-inline" style="padding-top:0px;"><div class="radio"><input type="radio" name="kinsnurseolk_actAbility" value="3"> 失能</div></label>'+
	'                     </div>'+
	'               </div>'+
	'               <div class="form-group">'+
	...
	'                     <div class="col-sm-5">'+
	'                         <input id="nurse_insure_no" class="form-control" disabled>'+
	'                     </div>'+
	'               </div>'+
	'               <div class="form-group">'+
	'                     <label class="col-sm-3 control-label">申请时间:</label>'+
	'                     <div class="col-sm-5">'+
	'                         <input id="nurse_insure_createTime" disabled class="form-control">'+
	'                     </div>'+
	'               </div>'+
	'				<div class="row"><label class="control-label">评估项:<label></div>'+
	'               <div class="form-group" id="nurse_assess_itemDiv">' +
	'                     <div class="col-sm-6">' +
	'                     	<select class="form-control" id="nurse_insure_assessItem" disabled="disabled"></select>' +
	'                     	<select class="form-control" id="nurse_insure_assessItem" disabled="disabled"></select>' +
	'                     	<select class="form-control" id="nurse_insure_assessItem" disabled="disabled"></select>' +
	'                     	<select class="form-control" id="nurse_insure_assessItem" disabled="disabled"></select>' +
	'                     	<select class="form-control" id="nurse_insure_assessItem" disabled="disabled"></select>' +
	...
	'                     <div class="col-sm-5">'+
	'                     		  <input id="nurse_insure_score" disabled class="form-control">'+
	'                     </div>'+
	'					  <span>全失能（得分<=40）或半失能（得分40~60）且伴随一定程度的失智才能享受长护险政策</span>'+
	'               </div>'+
	'               <div class="form-group">' +
	'                     <div class="col-sm-5">' +
...
//图片上传逻辑处理
$('body').on('change', '#nurse_insure_access .js-upload-file-input', function(){
	var inputEl = $(this);
